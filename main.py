        ...
        if await check_if_exists(chat_id=message.chat.id) is not None:
            try:
                if len(message.text.split()) <= 3:
                    ...
                    message_text = f'🧐 Я принимаю 2 числа на вход. Первое число - порядковый номер параметра, второе - желаемое значение.'
                    await bot.send_message(chat_id=message.chat.id, text=message_text)
            except ValueError:
        ...
        if await check_if_exists(chat_id=message.chat.id) is not None:
            try:
                ...
                if len(message.text.split()) <= 3:
                    ...
                    await bot.send_message(chat_id=message.chat.id, text=f'🧐 Я принимаю 2 числа на вход. Первое число - порядковый номер параметра, второе - желаемое значение.')
            except ValueError:
        ...
        if await check_content(chat_id=message.chat.id) is not None:
            try:
                if len(message.text.split()) <= 2:
                    ...
                    message_text = f'🧐 Я принимаю только одно число на вход - количество человек в таблице. Пример: "/leaders 10" - выведет таблицу с 10 людьми.'
                    await bot.send_message(chat_id=message.chat.id, text=message_text)
            except ValueError:
